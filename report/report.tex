...
Im Folgenden stellen wir die finale Lösung vor, welche wir als das Endergebnis des 
Projektes präsentieren. Die zahlreichen Ansätze, die wir verfolgt haben, um zu
diesem Punkt zu gelangen, stellen wir im folgenden Kapitel vor (siehe \ref{sec:ansaetze}).

\subsection{Programmstruktur}

{\color{red}FIXME: Einleitung zu Filtern (muss mit den Ansätzen zusammenpassen)}

Jeder Filter verfügt
