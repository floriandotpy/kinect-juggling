...
Während der Projektzeit, im November 2013, ist die Xbox One und damit auch die Kinect for Xbox One, oder auch Kinect 2.0, erschienen.\cite{kinect2:verge} Die neue Kinect beinhaltet bessere Hardware und auch softwaretechnisch wurden viele Features implementiert, wie beispielsweise eine große Anzahl Möglichkeiten an Gesten- und Sprachsteuerung der Konsole.\cite{kinect2:gesturevoice} Wir haben sie aus verschiedenen Gründen nicht genutzt, stellen sie aber kurz vor.
