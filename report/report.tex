...
{\color{red} FIXME: Rolf, Bild/Spec-Grafik der Kinect 2\\}
Am 22. November 2013 ist in den USA und Europa die Xbox One und damit auch die Kinect for Xbox One, oder auch Kinect 2.0, erschienen.\cite{kinect2:wiki} Die neue Kinect bringt viel neue Hardware mit, die sie deutlich von der ersten Kinect hervorhebt. Auch softwaretechnisch wurden viele Features implementiert, wie beispielsweise eine große Anzahl Möglichkeiten an Gesten- und Sprachsteuerung der Konsole.\cite{kinect2:gesturevoice} In einer Reihe von Online-Technology-Magazinen hat die neue Kinect viele Bewertungen von 7 bis 9 von 10 Punkten bekommen.\cite{kinect2:wikikinect}
...
Mit noch verbauten 1 GB RAM kann die Kinect 2.0 bis zu 2 Gigabit an Informationen pro Sekunde verarbeiten. 
...
=======
>>>>>>> ad3505d562def489a2ae4f4535c725f89c368aac
