...
Mit Markteinführung der Microsoft Kinect im November 2010\cite{kinect:wiki} steht in vielen
...
\begin{figure}[H]
    ...
    \caption{\color{red}FIXME}
\end{figure}
\item {\em Objekte im Bild (bewegt/unbewegt)}\\
{\color{red}FIXME}
\begin{figure}[H]
    \centering
    ...
    \caption{\color{red}FIXME}
\end{figure}
\item {\em zwei Bälle vs vier/fünf Bälle}\\
{\color{red}FIXME}
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    ...
    \caption{\color{red}FIXME}
\end{figure}
\item {\em Hände nicht immer korrekt}\\
siehe oben
{\color{red}FIXME}
...
{\color{red}FIXME Effizienz. Speedup-Möglichkeiten?}

{\color{red}FIXME Anwendungsrelevanz.}
...
\bibitem{kinect:wiki}
Wikipedia: Kinect\\
\url{http://en.wikipedia.org/wiki/Kinect} (accessed on 2014-06-29).
