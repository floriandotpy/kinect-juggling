...
\scshape{Unter Aufsicht von:\\ {\bfseries Prof. Dr. Leonie Dreschler-Fischer\\ Dr. Benjamin Seppke}\\}
...
Wir beschreiben unsere Recherche zu Beginn des Projekts und erarbeiten daraus die 
Lösungsidee, von der wir zu Beginn ausgehen. Im Vergleich zu dieser 
Lösungsidee präsentieren wir dann unser Endergebnis, das anders implementiert ist,
als wir ursprünglich geplant hatten. Hierbei sprechen wir über verwendete
Algorithmen und erläutern die von uns gewählte Softwarearchitektur.
...
Über die ausgiebige Auseinandersetzung mit Echtzeitverarbeitung von Tiefendaten haben
wir auch über die Konzepte und Zusammenhänge der Bildverarbeitung große 
...
aber nicht all zu einschränkend, so dass die Software tatsächlich gut benutzbar ist.
