...
Hier ein paar Beispielprojekte, die mit Hilfe der Kinect durchgeführt wurden, um die vielfältige
Einsatzmöglichkeit zu zeigen.

FIXME: Beispielkinectprojekte! (soll sowas rein? Lieber ein Absatz statt einzelne Unterkapitel?) (zu jedem ein Beispielbild?)

\subsubsection{3D Puppetry: A Kinect-based Interface for 3D Animation}
In diesem Projekt wurde ein System entwickelt, mit dem 

\subsubsection{KinectAvatar: Fully Automatic Body Capture Using a Single Kinect}

\subsubsection{Accurate Motion Deblurring using Camera Motion Tracking and Scene Depth}

\subsubsection{Playing Catch and Juggling with a Humanoid Robot}

\subsubsection{Coherent Spatiotemporal Filtering, Upsampling and Rendering of RGBZ Videos}

\subsubsection{A Multi-Link-Flexible Robot Arm Catching Thrown Balls}
...
{\em A Multi-Link-Flexible Robot Arm Catching Thrown Balls}\\
