...
test_images = ((np.random.random_integers(0,255, small_shape).astype(np.uint8), np.random.random_integers(0,255, small_shape).astype(np.uint8)),
               ...
               (np.random.random_integers(0,255, small_shape).astype(np.float), np.random.random_integers(0,255, small_shape).astype(np.float)),
               (np.random.random_integers(0,255, large_shape).astype(np.float), np.random.random_integers(0,255, large_shape).astype(np.float)))
...
tests = (("1",  "Summation of arrays",                                           "img_dest = test_images[{i}][0] + test_images[{i}][1]"),
